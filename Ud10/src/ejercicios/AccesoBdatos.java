...
public class AccesoBdatos {
	...
	public static Empleado busquedaPorCodigo (int num) {
		try {
			PreparedStatement prSt = conecta.prepareStatement("SELECT * FROM emp WHERE EMPNO = ?");
			prSt.setLong(1, num);
//			Statement consulta = conecta.createStatement();
			...
			if (reg.next()) {
				emp.setEMPNO(reg.getInt(1));
				emp.setENAME(reg.getString(2));
				emp.setJOB(reg.getString(3));
				emp.setMGR(reg.getInt(4));
				emp.setHIREDATE(reg.getDate(5));
				emp.setSAL(reg.getDouble(6));
				emp.setCOMM(reg.getDouble(7));
				emp.setDEPTNO(reg.getInt(8));
			}
			else {
				emp=null;
			}
...
//			String sql="insert into dept values (?,?,?)";
//			PreparedStatement inserta =conecta.prepareStatement(sql);
//			inserta.setInt(1,registro.getEMPNO());
//			inserta.setString(2,registro.getENAME());
//			inserta.setString(3,registro.getJOB());
//			inserta.setLong(4,registro.getMGR());
//			
//			inserta.executeUpdate();
//			return 1;
//		} catch(SQLException e){
...
//				departamento.setENAME(reg.getString(2));
//				departamento.setJOB(reg.getString(3));
//			}
...
//			actualiza.setString(1,registro.getENAME());
